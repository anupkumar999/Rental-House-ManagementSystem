...
<title>House Rental | House Search Listing</title>
<!--Bootstrap -->
...
<?php 
$pric=intval($_GET['pri']);
$p=$pric%10;
$pr=$pric-$p;
$b=$pr/10;
$p=$p*10000;
$sql = "SELECT id from rentinsertion WHERE Bhk='".$b."'";
...
<?php 
$sql = "SELECT id,Fullname,Bhk,Price,AdDescription,Image1 FROM rentinsertion WHERE Bhk = '".$b."'";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
